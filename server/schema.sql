...
CREATE TABLE `users` (
  ...
  `currentTime` BIGINT NULL DEFAULT NULL,
...
CREATE TABLE `merchants` (
  ...
  `servicePhoneNumber` VARCHAR(55) NULL DEFAULT NULL,
...
CREATE TABLE `orders` (
  ...
  `orderItems` VARCHAR(400) NULL DEFAULT NULL,
  `orderShipments` INTEGER NULL DEFAULT NULL,
...
CREATE TABLE `items` (
  ...
  `priceHistory` VARCHAR(400) NULL DEFAULT NULL,
